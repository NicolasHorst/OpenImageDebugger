...
class CoeffBuf(interface.TypeInspectorInterface):
    """
    ...
    def get_buffer_metadata(self, obj_name, picked_obj, debugger_bridge):
        ...
        row_stride = int(picked_obj['stride'])
        ...
        buffer = debugger_bridge.get_casted_pointer(current_type, picked_obj['buf'])
    ...
    def is_symbol_observable(self, symbol):
        ...
        type_regex = r'(const\s+)?CoeffBuf(\s+?[*&])?'
