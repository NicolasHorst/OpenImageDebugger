...
class PelUnitBuf(interface.TypeInspectorInterface):
    """
    ...
    def get_buffer_metadata(self, obj_name, picked_obj, debugger_bridge):
        ...
        current_type = str(picked_obj['bufs']['_arr'][0].sbtype.GetTemplateArgumentType(0))
    ...
    def is_symbol_observable(self, symbol, symbol_name):
        ...
        type_regex = r'(const\s+)?C?PelUnitBuf(\s+?[*&])?'
